...
export default function SmartEconomy() {
  ...
  useEffect(() => {
    const fetchInovasi = async () => {
      try {
        setLoading(true);
        const response = await apiEndpoints.inovasi.getAll('Smart Economy');
        ...
        const transformedData = inovasiData.map(item => ({
          ...
          views: '0 views',
          readTime: '5 min',
          image: item.image ? `/images/${item.image.name}` : '/images/default.jpg'
        }));
    ...
    <div className="explore-page">
      ...
      <section className="explore-hero">
        <div className="explore-hero-content">
          <h1 className="explore-hero-title">Smart Economy</h1>
                  ...
                  {paginatedArtikel.map(item => (
                    <article key={item.id} className="explore-card">
                      {item.category === 'inovasi' ? (
                        <div className="explore-card-image" onClick={() => handleImageClick(paginatedArtikel.indexOf(item))}>
                        ...
                        <>
                          ...
                          <div className="explore-card-body">
                            ...
                            <div className="explore-card-footer">
                              ...
                              <Link to={`/artikel/${item.id}`} className="explore-read-more">
                                Baca Selengkapnya
