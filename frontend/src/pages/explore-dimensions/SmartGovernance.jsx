...
export default function SmartGovernance() {
  ...
  useEffect(() => {
    const fetchInovasi = async () => {
      try {
        setLoading(true);
        const response = await apiEndpoints.inovasi.getAll('Smart Governance'); // Replace with actual dimensiId
  ...
  const handleImageClick = (item) => {
    ...
    setInovasiImages(filteredArtikel.map(artikel => ({ src: artikel.image, title: artikel.title })));
    setShowModal(true);
  };
    ...
    <div className="explore-page">
      ...
      <section className="explore-hero">
        <div className="explore-hero-content">
          <h1 className="explore-hero-title">Smart Governance</h1>
